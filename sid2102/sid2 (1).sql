...
--
-- Host: localhost
-- Generation Time: Feb 20, 2021 at 10:37 PM
...
(1, 'ABC', '5201142005', 'Muhammad Ilham ', '--', '83355', 'Batulay4r ', '520114', 'Bambang Budi Sanyoto, S. H', '-', 'Lombok Bart ', '5201', 'Nusa Tenggara Barat', '52', 'opensid_logo__sid__bXziTU1.png', '-8.483832804795249', '116.08523368835449', 14, 'HYBRID', '[[[-8.470247273601585,116.03699684143068],[-8.470993084228864,116.03974342346193],[-8.471775371367853,116.04249000549318],[-8.474831548688417,116.04557991027833],[-8.47754813036,116.04334831237793],[-8.478736628804842,116.0522747039795],[-8.48688623339785,116.04712486267091],[-8.492319207044495,116.04626655578615],[-8.492319207044495,116.04866981506349],[-8.490281850938663,116.05433464050294],[-8.499110315926593,116.06446266174318],[-8.507429260374638,116.06068611145021],[-8.509466525358253,116.05605125427248],[-8.501656950751967,116.04969978332521],[-8.501656950751967,116.046781539917],[-8.503694246430312,116.04454994201662],[-8.496820982890759,116.0453224182129],[-8.494953428786745,116.03931427001955],[-8.48986005320605,116.0365676879883],[-8.48493639256516,116.03364944458009],[-8.47975533883251,116.03768348693849]]]', 'Jl. Raya Senggigi Km 10 Kerandangan ', '', '', '', NULL);
...
(1612, 97, 46, 51, 37, '2021-01-19 13:15:07', 28, 9, 0, 0),
(1613, 97, 46, 51, 37, '2021-02-02 13:13:46', 28, 9, 0, 0);
...
(1, 'admin', '$2y$10$pcWb1dh8WMq6CbWIjrxJ/uM2OPFAUT1doa1gEh19.5FW8SjyAe04y', 1, 'info@opendesa.id', '2021-01-27 21:26:28', 1, 'Administrator', 'ADMIN', '321', 'favicon.png', 'a8d4080245664ed2049c1b2ded7cac30'),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`mfahri`@`localhost` SQL SECURITY DEFINER VIEW `daftar_grup`  AS SELECT `a`.`id_grup` AS `id_grup`, `a`.`nama_grup` AS `nama_grup`, (select count(`anggota_grup_kontak`.`id_kontak`) from `anggota_grup_kontak` where `a`.`id_grup` = `anggota_grup_kontak`.`id_grup`) AS `jumlah_anggota` FROM `kontak_grup` AS `a` ;
